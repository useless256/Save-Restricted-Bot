...
• <code>&lt;a href='url'&gt;Link&lt;/a&gt;</code> - Hyperlink
...
async def show_settings_panel(client, message, user_id):
    ...
    mode_btn_text = "📁 Mode: PM" if mode == "PM" else "📢 Mode: CHANNEL"
    next_mode = "Channel" if mode == "PM" else "PM"
    settings_text = (f"<b>⚙️ Settings</b>\n\n<b>Mode:</b> {mode}\n<b>Target:</b> {chat or 'Private'}")
    ...
    for msgid in range(fromID, toID + 1):
        ...
        try:
            ...
            if is_private:
                ...
                await handle_private(client, client, message, chatid, msgid)
        except: pass
